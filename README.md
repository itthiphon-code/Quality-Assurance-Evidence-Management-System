...
> สถานะปัจจุบัน: **Deploy ขึ้น production แล้วที่ https://ems.utc.ac.th** (Phase 1–4 ครบ) พร้อมปรับให้ผู้ประเมิน สมศ./บุคคลทั่วไปเข้าดูแฟ้มตรวจเยี่ยมและสถิติได้จากหน้าแรกโดยไม่ต้องเข้าสู่ระบบ (ยกเลิกบทบาทผู้ประเมินที่ต้องล็อกอินแบบเดิม). ดูรายละเอียดแผนทั้งหมดที่ `BUILD_PROMPT.md`
