...
> สถานะปัจจุบัน: **Phase 2 — Core evidence workflow** (อัปโหลดไฟล์/แนบลิงก์ Google Drive, ส่งตรวจ, คิวตรวจสอบของงานประกันคุณภาพ, มอบหมายผู้รับผิดชอบ, จัดการผู้ใช้/ตัวชี้วัด, แจ้งเตือน). ดูรายละเอียดแผนทั้งหมดที่ `BUILD_PROMPT.md`
